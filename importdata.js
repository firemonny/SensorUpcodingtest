...
var foodgroup ="foodgroups-en.json";
var foods ="foods-en.json";
var servings_per_day = "servings_per_day-en.json";
// global variable
var directiontable = JSON.parse(fs.readFileSync(directinfile, 'utf8'))["directional_statements"];
var foodgrouptable = JSON.parse(fs.readFileSync(foodgroup, 'utf8'))["foodgroups"];
var foodstable =     JSON.parse(fs.readFileSync(foods, 'utf8'))["foods"];
var personserving =  (JSON.parse(fs.readFileSync(servings_per_day, 'utf8')))["servings to per to miy"];
